<template>
    ...
    <div class="collapse py-2" style="padding-left: 50px;" id="js_introduction">
    ...
    <div class="collapse py-2" style="padding-left: 50px;" id="js_needed_webpages">
        <br>
    ...
    In HTML, JavaScript code is inserted between {{ '< script> ' }} and {{ '</script>' }} tags. <br>
        ...
        <p>Call, Bind, Apply :- <a
                href="https://www.geeksforgeeks.org/explain-call-apply-and-bind-methods-in-javascript/">Link</a> </p>
        <p>Curry Functions :- <a href="https://www.slideshare.net/slideshow/higherorder-functions/27802353#2">Link</a>
        </p>
